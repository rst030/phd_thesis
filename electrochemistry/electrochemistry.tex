...
The electrochemical window of Acetonitrile is between -3.45~V and +2.35~V vs. SCE (+0.268 V vs SHE).
...
Duting the charging of a pDiTS half-cell, its electrochemically active cathode film is being oxidized: positive charges are being injected into it. 
When the Fermi energy of the metal approaches the oxidation potential of pDiTS, a positive charge charge is injected to its backbone. A negative BF4${^-}$ ion is attracted from the electrolyte solution to the positively charged backbone.\\
