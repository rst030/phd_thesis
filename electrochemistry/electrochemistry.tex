...
\end{figure}
Tetraetylammonium tetrofluoroborate is a salt that dissociates a cation and anion in polar solvents such as acetonitrile.

\subsubsection{Polymer Electrolyte}
The use of ionic liquids and the suitable polymer matrix allows for fabrication organic electrochemical transistors and can be used for making an all-polymer organic radical battery. PVDF was used as a polymer matrix. TMIMTFSI was the ionic liquid.
